...
- Date/time: 2026-07-14 18:06 UTC
- Git commit: repository commit containing this record
- Operator: Codex, using the owner-selected public HyperEVM RPC
- Manifest version: `hyperevm-usdp-candidate-v1`
- Reference block: HyperEVM `40459916`, hash `0x90b628e9e0a19fded2afabe79e8382c5c4adef3e2aa8ffadd1cf182ab2479c81`
- Environment: local client against `https://rpc.hyperliquid.xyz/evm`; Railway PostgreSQL and service were already healthy
...
npm run check
PASS - secret scan, format, ESLint, strict TypeScript, 21 deterministic tests, and Next.js production build. PostgreSQL integration and opt-in network lanes were skipped by the default gate as designed.
...
- USDp proxy `0xBE65F0F410A72BeC163dC65d46c83699e957D588` was deployed at block `5035286` in transaction `0x915212321e7364fe67bb474b74698b91e0bcf62d20f2537c862bd3523eb5c9ae`. The live ERC-1967 implementation equals official candidate `0x24CeF236056834f38e9247A1Fff6681Dd313D3aA`.
...
- Official DIA sUSDp/USD feed `0xdcA437D1492Db6E9438A82Ad31Cab92E2eE159E1`: `1.069741037702936442` USD, 18 decimals.
...
- The public RPC is suitable for current-state discovery and bounded log tests, but not an efficient seven-day or lifetime backfill.
- Its historical `eth_call` response was temporally inconsistent with the requested deployment block, proving that pinned historical state is not honored.
- Phase 1 therefore remains explicitly `candidate`, not approved. No metric will be labeled reconciled or historical until an archive-capable, higher-throughput RPC repeats the pinned-block discovery and supports the Phase 2 backfill.
- No owner action is required to keep the candidate service deployed. Before Phase 2 backfill, the owner must add an archive-capable HyperEVM RPC URL to Railway or approve a suitable provider.
